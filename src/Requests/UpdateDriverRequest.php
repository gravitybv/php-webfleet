 ...
 *
 * Represents the parameters required for the updateDriverExtern endpoint.
 */
class UpdateDriverRequest
{
    /** @var string|null New driver number to be set for the driver. */
    ...
    /** @var string|null Old driver number. */
    public ?string $driverno_old = null;

    /** @var string|null Unique driver identifier. */
     ...
     */
    public function __construct(string $driveruid)
    {
